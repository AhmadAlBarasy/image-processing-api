...
import { getCropSchema, getResizeSchema, getBlurSchema } from '../utils/joiSchemas';
...
apiRouter.route('/resize').post(validateBody(getResizeSchema), imageResizeController);
